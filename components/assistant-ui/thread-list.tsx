  ...
  return (
    <ThreadListPrimitive.New
      render={
        <button
          type="button"
          className="aui-thread-list-new mb-2 flex h-10 w-full min-w-0 items-center rounded-none text-left transition-colors hover:bg-[#eceae4] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-(--claude-accent)/25 data-active:bg-[#eceae4]"
        />
      }
    >
      <span
      ...
      >
        <span className="flex size-6 items-center justify-center rounded-full bg-[#eceae4] text-(--claude-text)">
      ...
      <ThreadListItemMorePrimitive.Trigger
        render={
          <Button
            variant="ghost"
            size="icon"
            className="aui-thread-list-item-more me-1 size-7 p-0 text-(--claude-muted) opacity-0 transition-opacity group-hover:opacity-100 group-data-active:opacity-100 data-[state=open]:bg-[#e8e4de] data-[state=open]:opacity-100"
          />
        }
      >
